...
with excerpts from a few JSON files selected using the query text and Mosaic
group names. This keeps requests focused on the most relevant data and helps
avoid conflicting information in answers.
